...
class BaseAviary(gym.Env):
    ...
    def reset(self):
        ...
        """
        #self.INIT_RPYS = np.pi*(np.random.rand(1,3)-1)
        ...
        return self._computeObs(), 2*np.pi*(np.random.rand(3)-0.5)
    ...
    def step(self,
        ...
        reward = self._computeReward(setpoint)
    ...
    def _dynamics(self,
        ...
        #### Update state ##########################################
        vel = 0 #vel + self.TIMESTEP * no_pybullet_dyn_accs
